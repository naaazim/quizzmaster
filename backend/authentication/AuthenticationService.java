...
import com.example.RegisterLogin.appuser.*;
import com.example.RegisterLogin.confirmationtoken.*;
import com.example.RegisterLogin.email.EmailSender;
import com.example.RegisterLogin.security.JwtService;
...
public class AuthenticationService {
    ...
    /*enregistre l'utilisateur dans la base de donnéess'il n'existe pas
     et renvoie un token pour activer le compte*/
    ...
    //confirmation du token de l'inscription
    public String confirmToken(String token) {
        ...
        appUserRepository.activeAppUser(
                confirmationToken.getAppUser().getEmail());
        return "confirmed";
    }


    //authentifie l'utilisateur et renvoie un token JWT et l'utilisateur connecté
    ...
    //renvoie un mot de passe genéré aléatoirement
    ...
    //ajoute un utilisateur sans avoir à activer le compte
    public AppUser adminAjouteUser(RegistrationRequest request){
        ...
        emailSender.send(
                    request.getEmail(),
                    buildEmailMdp(request.getPassword()));
        AppUser user = new AppUser(request.getFirstName(), request.getLastName(), request.getEmail(), passwordEncoder.encode( request.getPassword()), true, true);
